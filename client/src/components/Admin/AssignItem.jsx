            ...
            <div className="flex">
                ...
                <div className="flex flex-wrap items-stretch w-[1100px]" >
                    ...
                    >
                        ...
                        {/* Chair Icon */}
                        <i class="fas fa-chair fa-3x text-center mt-4 mb-4 "></i>
                        <p
                            className="
                    ...
                    >
                        ...
                        {/* Board Marker Icon */}
                        <i class="fas fa-marker fa-3x text-center  mt-4 mb-4 "></i>
                        <p
                            className="
                            text-blue-400 text-sm
                            bg-white
                    ...
                    >
                        ...
                        {/* Table Icon */}
                        <i class="fas fa-table fa-3x text-center  mt-4 mb-4 "></i>
                        <p
                            className="
                            text-blue-400 text-sm
                            bg-white
